...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d\_regresion }\OtherTok{\textless{}{-}}\NormalTok{ d[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{11}\NormalTok{]}
\NormalTok{d\_regresion}\SpecialCharTok{$}\NormalTok{category }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(d\_regresion}\SpecialCharTok{$}\NormalTok{category)}
\NormalTok{d\_regresion}\SpecialCharTok{$}\NormalTok{generation }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(d\_regresion}\SpecialCharTok{$}\NormalTok{generation)}
\end{Highlighting}
\end{Shaded}
